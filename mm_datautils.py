...
def videollava_get_mm_adapter_state_maybe_zero_3(named_params, keys_to_match):
...
def videollava_safe_save_model_for_hf_trainer(trainer: transformers.Trainer,
                                   output_dir: str):
    """Collects the state dict and dump to disk."""
    ...
    if getattr(trainer.args, "tune_mm_mlp_adapter", False):
        ...
        weight_to_save = videollava_get_mm_adapter_state_maybe_zero_3(
